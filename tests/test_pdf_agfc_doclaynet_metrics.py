...
from agfc.doclaynet_metrics import (
    aggregate_doclaynet_results,
    bbox_iou,
    evaluate_doclaynet_page,
)
...
def test_evaluate_doclaynet_page_reports_iou_f1_and_recall():
    gt_page = {
        "page_idx": 0,
    ...
    result = evaluate_doclaynet_page(gt_page, predictions, iou_threshold=0.5)
...
def test_aggregate_doclaynet_results_combines_page_metrics():
    page_results = [
        {
            "page_idx": 0,
            "gt_count": 2,
    ...
    result = aggregate_doclaynet_results(page_results)
