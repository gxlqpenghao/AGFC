...
The MinerU repair adapter is intentionally independent of consumer-specific internals. Downstream consumers should call AGFC through CLI, HTTP, or Python API, then map AGFC JSON into their own internal types. See [Consumer Integration](docs/integrations/consumer-integration.md).
